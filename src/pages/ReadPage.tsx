...
const articles = [
  { tag: "Wellness",  title: "5 soft morning rituals to start your day glowing",      mins: 4, accent: "#ec7aa0", img: photos.morning },
  { tag: "Cycle",     title: "Understanding your cycle phases (and your moods)",       mins: 6, accent: "#a87ad8", img: featCycle      },
  { tag: "Money",     title: "The cute girl's guide to a no-stress budget",            mins: 5, accent: "#5cb874", img: photos.money   },
  { tag: "Mind",      title: "Journaling prompts for a calmer, kinder mind",          mins: 3, accent: "#efb24d", img: featDiary      },
  { tag: "Body",      title: "Gentle movement: pilates flows for slow days",          mins: 7, accent: "#5cc0cc", img: photos.pilates },
  { tag: "Glow",      title: "Building a skincare routine you'll actually keep",       mins: 5, accent: "#e88ac0", img: photos.roses   },
  { tag: "Rituals",   title: "Your dream morning routine, step by step",              mins: 4, accent: "#ec6f9e", img: photos.ritual  },
];
      ...
      <div className="group relative mb-6 cursor-pointer overflow-hidden rounded-3xl shadow-soft">
        ...
        <div className="absolute bottom-0 left-0 p-5">
          ...
          <p className="mt-1 flex items-center gap-1 text-xs text-white/80">
            <Clock className="size-3.5" /> {featured.mins} min read
          </p>
        </div>
      </div>
